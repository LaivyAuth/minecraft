...
import com.laivyauth.serializable.Serializer;
        ...
        if (mappingFiles != null) for (@NotNull File mappingFile : mappingFiles) try {
            ...
            try (@NotNull JarFile jar = new JarFile(mappingFile)) {
                ...
                if (Mapping.class.isAssignableFrom(main)) {
                    ...
                    @NotNull Constructor<Mapping> constructor = ((Class<Mapping>) main).getDeclaredConstructor(ClassLoader.class, com.laivyauth.api.LaivyAuthApi.class, Configuration.class);
            ...
            log.error("Cannot find a valid constructor of mapping '{}'. It should have a constructor with '{}', '{}' and '{}' parameters.", mappingFile.getName(), ClassLoader.class, com.laivyauth.api.LaivyAuthApi.class, Configuration.class);
            log.atError().setCause(e).log();
