...
import com.laivyauth.mapping.v1_21_R1.Main;
import com.laivyauth.mapping.v1_21_R1.reflections.PlayerReflections;
import com.laivyauth.mapping.v1_21_R1.reflections.ServerReflections;
...
import static com.laivyauth.mapping.v1_21_R1.reflections.ServerReflections.chat;
        ...
        if (message instanceof @NotNull PacketLoginOutEncryptionBegin begin) {
            ...
            if (Main.getApi().getConfiguration().getPremiumAuthentication().isEnabled()) {
                ...
                if (connection.getType() == null) {
                    ...
                    @Nullable LoginListener listener = (LoginListener) PlayerReflections.getNetworkManager(channel).k();
