...
import static com.laivyauth.mapping.v1_20_R2.reflections.ServerReflections.*;
            ...
            try {
                ...
                try {
                    if (!begin.a(encryption, privateKey)) { // Check if challenge is valid
                        ...
                        secret = new BigInteger(digestData("", publicKey, secretkey)).toString(16);
                    }
